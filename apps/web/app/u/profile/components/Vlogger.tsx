...
function Main() {
    ...
    async function fetchPosts() {
        try {
            ...
            const response = await fetch(`http://localhost:3001/api/vlogger/posts?${profileData?.userId}`, {
                method: "GET",
    ...
    async function fetchVloggerData() {
        ...
        try {
            const response = await fetch(`http://localhost:3001/api/user/details/vlogger/?userId=${userId}`, {
                method: "GET",
                headers: {
                    "Content-Type": "application/json",
                },
    ...
    return (
        <>
            <div className="p-4">
                ...
                <div>
                    <div className="flex space-x-123">
